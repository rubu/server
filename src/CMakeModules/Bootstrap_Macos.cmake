...
FIND_PACKAGE (Boost 1.72.0 COMPONENTS system thread chrono filesystem log locale regex date_time coroutine REQUIRED)
...
LINK_DIRECTORIES( ${FFMPEG_LIBRARY_DIRS} /usr/local/lib )
...
ADD_COMPILE_OPTIONS(-Wno-unused-function -Wno-unused-local-typedef -Wno-unused-variable)
...
function(casparcg_add_macos_resource RESOURCE)
	set(CASPARCG_MACOS_RESOURCES "${CASPARCG_MACOS_RESOURCES}" "${RESOURCE}" CACHE INTERNAL "")
endfunction()
