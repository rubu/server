...
struct param_visitor : public boost::static_visitor<void>
{
	...
	void operator()(const int32_t value)				{o << static_cast<::osc::int64>(value);}
	void operator()(const uint32_t value)				{o << static_cast<::osc::int64>(value);}
	void operator()(const int64_t value)				{o << static_cast<::osc::int64>(value);}
	void operator()(const uint64_t value)				{o << static_cast<::osc::int64>(value);}
